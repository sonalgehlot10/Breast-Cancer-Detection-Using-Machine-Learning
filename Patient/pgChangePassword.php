...
if(!isset($_SESSION["bcusername"])){
	...
	$db=new DB_connect();
	$con=$db->connect();
	$DataBaseUserName = $_SESSION["bcusername"];
	//Query To Get Old PASSWORD
	$query="Select Password From bc_patient_details Where Email='".$DataBaseUserName."'";
	//echo $query;
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
			...
			<div class="control-group">
				  <div class="form-group col-xs-12 floating-label-form-group controls">
					...
					<center><button class="btn btn-primary" onclick="changePatientPassword();" style="width:auto" >CHANGE PASSWORD</button></center>
		...
		$.ajax({
			...
			console.log(response);
				if($.trim(response)=="success"){
					...
					$("#txtNewPassword").val("");
					$("#txtRePassword").val("");
					$(location).attr('href','pgPatientLogin.php');
				}
				else{
