...
if(!isset($_SESSION["bcusername"])){
	...
	$query="Select Password From bc_admin Where Username='".$_SESSION["bcusername"]."'";
	//echo $query;
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
			...
			<div class="control-group">
				  <div class="form-group col-xs-12 floating-label-form-group controls">
					...
					<center><button class="btn btn-primary" onclick="changeAdminPassword();" style="width:auto" >CHANGE PASSWORD</button></center>
